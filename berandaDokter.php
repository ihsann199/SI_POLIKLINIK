...
<style>
    .jumbotron {
        background: url('images/dokter1.jpg') no-repeat center center;
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="berandaDokter.php?page=jadwalPeriksa">Jadwal Periksa</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="berandaDokter.php?page=riwayatPasien">Riwayat Periksa</a>
                        </li>
                        <li class="nav-item">
